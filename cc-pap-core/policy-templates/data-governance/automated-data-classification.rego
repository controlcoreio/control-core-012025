package cc.policies.data_classification.automated_data_classification

# Automated Data Classification
# Automatic classification of data based on content
...
response := {
    "allow": allow,
    "policy": "automated-data-classification",
