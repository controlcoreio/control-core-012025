package cc.policies.pipeda.pipeda_consent_principles

# PIPEDA Consent Principles
# Enforce PIPEDA consent requirements for personal information
...
response := {
    "allow": allow,
    "policy": "pipeda-consent-principles",
