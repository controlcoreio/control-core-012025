...
echo "   • cc-pap (Frontend with Language Server) - Port 5173"
...
echo "   • cc-bouncer (PEP + PDP + OPAL) - Port 8080"
echo "   • cc-bouncer-sidecar (Kubernetes sidecar)"
echo ""
echo "   Supporting Services:"
echo "   • cc-signup-service - Port 8002"
echo "   • cc-docs (Documentation) - Port 3000"
echo "   • cc-business-admin (Analytics)"
echo ""
echo "   Infrastructure:"
echo "   • cc-infra/local-development (Local dev compose)"
echo "   • cc-infra/client-deployments (Production configs)"
echo "   • PostgreSQL (Database) - Port 5432"
echo "   • Redis (Cache) - Port 6379"
echo ""
echo "   Demo Applications:"
echo "   • cc-demoapp (Demo frontend)"
echo "   • cc-demoapp-api (Demo backend)"
echo "   • cc-demoapp-policies-repo (Sample policies)"
echo ""
echo "   🎯 Development Dependencies:"
echo "   • cc-pap ↔ cc-pap-api ↔ cc-pap-core"
...
cd "$SCRIPT_DIR/cc-infra/local-development"
...
# Start infrastructure services from cc-infra/local-development
$DOCKER_CMD compose up -d cc-db cc-redis cc-pap-api cc-pap cc-bouncer 2>&1 | grep -E "(Starting|Started|created|healthy|Error)" || true
...
if check_port 8002; then
    ...
    cd "$SCRIPT_DIR/cc-infra/local-development"
    $DOCKER_CMD compose up -d cc-signup-service 2>&1 | grep -E "(Starting|Started|created|healthy|Error)" || true
...
echo "   • cc-pap changes → consider cc-pap-api, cc-pap-core"
...
echo "   • cc-infra changes → test both local-development and client-deployments"
echo ""
echo "   📁 New Infrastructure Structure:"
echo "   • Local dev: cc-infra/local-development/"
echo "   • Production: cc-infra/client-deployments/"
echo ""
echo "   📝 Current Branch: $(git branch --show-current)"
echo "   🔄 Sync with: git push origin dev"
echo ""
echo "   🛑 Stop all services: ./stop-all-services.sh"
echo "   (Stops services, cleans up, and pushes to GitHub)"
echo ""
