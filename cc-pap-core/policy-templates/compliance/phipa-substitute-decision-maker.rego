package cc.policies.phipa.phipa_substitute_decision_maker

# PHIPA Substitute Decision Maker
# Control access by substitute decision makers
...
response := {
    "allow": allow,
    "policy": "phipa-substitute-decision-maker",
