package cc.policies.ai_security.rag_data_protection_pii

# RAG Data Protection - PII
# Protect PII in RAG system retrievals and responses
...
response := {
    "allow": allow,
    "policy": "rag-data-protection-pii",
