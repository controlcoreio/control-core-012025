package cc.policies.canadian_ai_governance.algorithmic_impact_assessment

# Algorithmic Impact Assessment (AIA)
# Comprehensive algorithmic impact assessment policy
...
response := {
    "allow": allow,
    "policy": "algorithmic-impact-assessment",
