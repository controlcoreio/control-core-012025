package cc.policies.ai_security.ai_agent_boundary_enforcement

# AI Agent Boundary Enforcement
# Enforce operational boundaries for AI agents
...
response := {
    "allow": allow,
    "policy": "ai-agent-boundary-enforcement",
