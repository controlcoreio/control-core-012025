package cc.policies.canadian_aida.high_impact_ai_system_assessment

# High-Impact AI System Assessment
# Assessment policy for high-impact AI systems under Canadian AIDA
...
response := {
    "allow": allow,
    "policy": "high-impact-ai-system-assessment",
