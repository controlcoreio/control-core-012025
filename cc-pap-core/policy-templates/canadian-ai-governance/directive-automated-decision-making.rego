package cc.policies.canadian_ai_governance.directive_automated_decision_making

# Directive on Automated Decision-Making
# Compliance with Canadian government directive on automated decision-making
...
response := {
    "allow": allow,
    "policy": "directive-automated-decision-making",
