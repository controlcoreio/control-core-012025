#!/usr/bin/env python3
"""
Simple test server for cc-signup-service on port 8002
"""
...
async def serve_frontend_root():
    ...
    if os.path.exists(index_path):
        ...
        return response
    return {"message": "Control Core Signup Service", "status": "running", "port": 8002}
...
async def serve_logo():
    ...
    # Try app/static
    logo_path_alt = os.path.join(os.path.dirname(__file__), "app", "static", "logo.png")
    if os.path.exists(logo_path_alt):
        return FileResponse(logo_path_alt, media_type="image/png")
...
async def serve_favicon():
    ...
    # Try app/static
    favicon_path_alt = os.path.join(os.path.dirname(__file__), "app", "static", "favicon.ico")
    if os.path.exists(favicon_path_alt):
        return FileResponse(favicon_path_alt, media_type="image/x-icon")
...
async def serve_controlcore_icon():
    ...
    # Try app/static
    icon_path_alt = os.path.join(os.path.dirname(__file__), "app", "static", "controlcore-icon.svg")
    if os.path.exists(icon_path_alt):
        return FileResponse(icon_path_alt, media_type="image/svg+xml")
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting cc-signup-service on port {port}...")
