package cc.policies.phipa.phipa_consent_directives

# PHIPA Consent Directives
# Manage PHIPA consent directives for health information
...
response := {
    "allow": allow,
    "policy": "phipa-consent-directives",
