...
export function GitHubConfigurationPage() {
  ...
  const handleManualSync = async () => {
    // Manual sync now triggers all bouncers to pull controls from GitHub
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `${data.success_count} bouncers will pull controls from GitHub`,
        });
    ...
    <div className="container py-10 max-w-5xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Configure your organization's default GitHub repository for control storage
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          <p className="mb-2">
            This is your organization's <strong>master control repository</strong>. When you create or edit controls in the Control Plane, 
            they are written here. All bouncers can use this repository by default.
          </p>
          <div className="space-y-1 text-sm">
            <div>✓ Control Plane commits <code className="bg-muted px-1 rounded">.rego</code> files to this repository</div>
            <div>✓ Bouncers pull controls from their assigned resource folders</div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Configure your GitHub repository for control storage</CardDescription>
            </div>
            {getStatusIcon()}
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-3">
            ...
            <Input
              id="repoUrl"
              placeholder="https://github.com/your-org/controls-repo"
          ...
          <div className="space-y-3">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Branch to use for control storage (default: main)
            </p>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure automatic control synchronization</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          {!settings.autoSync && (
            <Alert>
              <Info className="h-4 w-4" />
              <AlertDescription>
                Automatic sync is disabled. You can use Manual Sync to trigger all bouncers to pull controls from GitHub.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="space-y-3">
            ...
            {!settings.repoUrl || !settings.accessToken ? (
              ...
              <p className="text-xs text-green-600 text-center">
                ✓ Ready to trigger all bouncers to pull controls from GitHub
              </p>
            )}
          </div>
            ...
            <Alert className="mt-4 border-blue-200 bg-blue-50">
              ...
              <AlertDescription className="text-blue-800">
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                  ...
                  <li>Each bouncer's OPAL Server re-syncs its controls</li>
                  <li>Latest controls loaded into OPA engines</li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Controls are organized by Protected Resource and Environment
          </CardDescription>
        </CardHeader>
          ...
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-800">
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                ...
                <li>Control Plane automatically creates the correct folder structure when you save controls</li>
              </ul>
            </AlertDescription>
          </Alert>
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <div className="mt-3 space-y-1 text-sm">
                ...
                <div><strong>[enabled|disabled]:</strong> Control activation status</div>
                <div><strong>[id]:</strong> Unique control ID from Control Plane database</div>
              </div>
            </AlertDescription>
          </Alert>
          ...
          <Alert className="border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              <ol className="list-decimal list-inside space-y-2 mt-2 text-sm">
                ...
                <li>Save settings - Control Plane will auto-create folder structure when you save your first control</li>
          ...
          {settings.connectionStatus === 'connected' && (
            <Alert className="border-blue-200 bg-blue-50">
              ...
              <AlertDescription className="text-blue-800">
                ...
                . Each bouncer will automatically sync controls from its resource's folder.
              </AlertDescription>
            </Alert>
          )}
        </CardContent>
