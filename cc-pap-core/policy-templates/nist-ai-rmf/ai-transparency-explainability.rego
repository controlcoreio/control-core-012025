package cc.policies.nist_ai_rmf.ai_transparency_explainability

# AI Transparency and Explainability
# Policy ensuring AI decisions are transparent and explainable
...
response := {
    "allow": allow,
    "policy": "ai-transparency-explainability",
